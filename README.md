...
### Выводы
Обе модели пригодны как базы рекомендаций; CatBoost даёт преимущество в возможностях расширения (учёт дополнительных фичей), а ALS представляет собой простой и быстрый базовый бейзлайн. При переобучении на всех данных результаты лучше.
